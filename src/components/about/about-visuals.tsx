...
const HoverPreview = dynamic(() => import("@/components/about/hover-preview"));

// Check your filename: if it is "orbiting-skills.tsx" (one 't'), change the import below.
// I kept 'orbitting' to match your error log.
const OrbitingSkills = dynamic(() => import("@/components/about/orbitting-skills"), { ssr: false });

const ImageReveal = dynamic(() => import("@/components/about/image-reveal"), { 
  ssr: false,
