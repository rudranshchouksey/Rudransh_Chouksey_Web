...
// --- FlipCard Component (Dark/Glass Style) ---
const IMG_WIDTH = 70;
    ...
    return (
        ...
        >
            ...
            >
                {/* Front Face */}
                <div
                    className="absolute inset-0 h-full w-full overflow-hidden rounded-lg border border-white/10 shadow-2xl bg-neutral-900"
...
const IMAGES = [
    ...
    'https://images.unsplash.com/photo-1748968218568-a5eac621e65c?w=900&auto=format&fit=crop&q=60',
    "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=2426",
    "https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&q=80&w=2532",
    "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&q=80&w=2670",
    'https://images.unsplash.com/photo-1748968218568-a5eac621e65c?w=900&auto=format&fit=crop&q=60',
    "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=2426",
    "https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&q=80&w=2532",
...
export default function ProjectMorphHero() {
    ...
    // --- Virtual Scroll Logic (WITH FIX FOR SCROLL RELEASE) ---
    ...
    useEffect(() => {
        ...
        const handleWheel = (e: WheelEvent) => {
            ...
            const atBottom = current >= MAX_SCROLL;
            const atTop = current <= 0;

            // FIX: If at boundaries, allow default scroll (bubbles up to window)
            if (atBottom && isScrollingDown) return;
            if (atTop && isScrollingUp) return;
        ...
        const handleTouchMove = (e: TouchEvent) => {
            ...
            // FIX: Release touch scroll at boundaries
            ...
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                ...
                <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2">
                    <motion.h1
                        ...
                        className="text-3xl font-bold tracking-tighter text-white md:text-5xl"
                    >
                        Selected Works
                    </motion.h1>
                    <motion.p
                        ...
                        className="mt-4 text-xs font-bold tracking-[0.3em] text-neutral-400"
                    >
                        SCROLL TO NAVIGATE
                    </motion.p>
                </div>
                ...
                >
                    ...
                    <p className="text-sm md:text-base text-neutral-400 max-w-lg leading-relaxed">
                        A curated selection of digital products, <br className="hidden md:block" />
